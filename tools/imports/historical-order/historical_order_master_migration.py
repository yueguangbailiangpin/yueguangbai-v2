...
def main() -> int:
    ...
    parser.add_argument("--mapping-dir", type=Path, default=Path(__file__).resolve().parents[3] / "openspec/changes/current-reservable-product-seller-mapping/references")
