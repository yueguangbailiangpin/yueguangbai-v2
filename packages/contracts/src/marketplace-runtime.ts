...
export const MARKETPLACE_RUNTIME_DEFINITIONS = Object.freeze({
  ...
  RAKUTEN_JP: Object.freeze({marketplace_code:'RAKUTEN_JP',business_timezone:'Asia/Tokyo',reporting_timezone:'Asia/Shanghai',currency_code:'JPY',currency_exponent:0}),
  YAHOO_JP: Object.freeze({marketplace_code:'YAHOO_JP',business_timezone:'Asia/Tokyo',reporting_timezone:'Asia/Shanghai',currency_code:'JPY',currency_exponent:0}),
  TEMU_JP: Object.freeze({marketplace_code:'TEMU_JP',business_timezone:'Asia/Tokyo',reporting_timezone:'Asia/Shanghai',currency_code:'JPY',currency_exponent:0}),
  TIKTOK_JP: Object.freeze({marketplace_code:'TIKTOK_JP',business_timezone:'Asia/Tokyo',reporting_timezone:'Asia/Shanghai',currency_code:'JPY',currency_exponent:0}),
