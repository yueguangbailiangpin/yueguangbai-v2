...
const evidence = [
  {
    ...
    implementation: [adapter, 'resolveAssignmentStaffAuthorization', 'resolveStaffDataScope'],
    test: [tests, 'forged Staff identity', 'Personal DENY'],
  },
  {
    requirement: 'Staff MCP v1 exposes bounded read and draft tools only',
    implementation: [tools, 'STAFF_MCP_MAX_LIMIT', 'additionalProperties: false'],
    test: [tests, 'executes every bounded read/draft tool', 'Buyer/Seller tools'],
  },
  {
