...
if (migrationFiles.length !== 28
  || migrationFiles.at(-2) !== '0027_staff_auth_sessions.sql'
  || migrationFiles.at(-1) !== '0028_buyer_amazon_order_date.sql') {
...

{
  ...
  if (schemaVersion(fresh) !== 28) throw new Error('fresh schema not 28');
