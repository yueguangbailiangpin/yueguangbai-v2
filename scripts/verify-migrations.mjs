...
const requiredTriggers = [
  ...
  'trg_acquisition_assignments_no_delete',
  'trg_acquisition_channel_events_no_delete',
  'trg_acquisition_channel_events_no_update',
  ...
  'trg_drive_archive_controls_no_delete',
  'trg_drive_archive_controls_update_guard',
  ...
  'trg_file_drive_archive_events_no_delete',
  'trg_file_drive_archive_events_no_update',
  'trg_file_drive_archive_insert_guard',
  'trg_file_drive_archive_manifests_no_delete',
  'trg_file_drive_archive_manifests_no_update',
  'trg_file_drive_archive_reconciliations_no_delete',
  'trg_file_drive_archive_reconciliations_no_update',
  'trg_file_drive_archive_transition_guard',
  'trg_file_drive_archives_no_delete',
  'trg_file_drive_rehydration_insert_guard',
  'trg_file_drive_rehydration_update_guard',
  'trg_file_drive_rehydrations_no_delete',
