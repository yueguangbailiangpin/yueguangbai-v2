...
const expectedLatestSchema = 24;
const expectedLastMigration = '0024_cold_archive_bundle_model.sql';
const expectedSchemaInventory = {
  table: 190,
  index: 565,
  trigger: 368,
  view: 12,
  sha256: '8b5b36f67d4571560b7e1bbb698b946455d771f4c13fcb1149aab3e1d134a3e2',
};
