...
const expectedLatestSchema = 32;
const expectedLastMigration = '0032_stage75_public_service_channels.sql';
const expectedSchemaInventory = {
  table: 158,
  index: 485,
  trigger: 305,
  view: 12,
  sha256: '4f67527c54ba40a50a0a78d405550a47a9c7f26cf8eb3a88b07edfb85901aee6',
};
