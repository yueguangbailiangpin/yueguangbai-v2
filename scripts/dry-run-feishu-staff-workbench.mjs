...
console.log(JSON.stringify({mode:'LOCAL_NO_NETWORK',staff_count:staffCount,daily_orders:dailyOrders,actionable_summaries:summaries,outbound_upserts:outboundUpserts,callback_budget:callbackBudget,adapter:'mock_only',runtime_default:'HARD_DISABLED',time_basis:'UTC_MS',display_timezone:'Asia/Shanghai'},null,2));
