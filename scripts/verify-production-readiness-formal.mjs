...
assert(runbook.includes('连续 `0001`–`0039`'),'current Migration baseline missing');
...
assert(migrations.length===39&&migrations.at(-2)==='0038_staff_mcp_production_transport_oauth.sql'&&migrations.at(-1)==='0039_staff_access_binding_management.sql','schema must be the governed 0001-0039 chain');
