...
assert(runbook.includes('连续 `0001`–`0040`'),'current Migration baseline missing');
...
assert(migrations.length===40&&migrations.at(-2)==='0039_staff_access_binding_management.sql'&&migrations.at(-1)==='0040_seller_partner_master_data_import.sql','schema must be the governed 0001-0040 chain');
