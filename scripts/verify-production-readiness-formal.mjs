...
assert(migrations.length===38&&migrations.at(-2)==='0037_product_reservation_order_scheduling.sql'&&migrations.at(-1)==='0038_staff_mcp_production_transport_oauth.sql','schema must be the governed 0001-0038 chain');
