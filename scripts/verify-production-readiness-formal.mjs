...
assert(runbook.includes('连续 `0001`–`0042`'),'current Migration baseline missing');
...
assert(migrations.length===42&&migrations.at(-4)==='0039_staff_access_binding_management.sql'&&migrations.at(-3)==='0040_seller_partner_master_data_import.sql'&&migrations.at(-2)==='0041_seller_principal_rate_policy.sql'&&migrations.at(-1)==='0042_rakuten_tiktok_jp_marketplace_foundation.sql','schema must be the governed 0001-0042 chain');
