...
async function seedFixture(db: SqliteDatabase): Promise<void> {
  db.exec(`
    ...
    INSERT INTO order_evidence_submissions (id, reservation_id, buyer_customer_id, marketplace_code, status, current_version_no, version, public_change_reason, internal_review_note, submitted_at, updated_at, verified_by_staff_id, verified_at, withdrawn_at, consumed_at, created_at) VALUES
      ('chat-submission-1', 'chat-reservation-1', 'buyer-customer-0001', 'JP', 'VERIFIED', 1, 1, NULL, NULL, 1, 1, 'staff-chat-uploader', 1, NULL, NULL, 1),
      ('chat-submission-2', 'chat-reservation-2', 'buyer-customer-0001', 'JP', 'VERIFIED', 1, 1, NULL, NULL, 1, 1, 'staff-chat-uploader', 1, NULL, NULL, 1);
    INSERT INTO formal_orders (id, order_evidence_submission_id, order_evidence_version_id, reservation_id, demand_batch_id, buyer_customer_id, buyer_customer_no, seller_organization_id, store_id, marketplace_code, product_id, product_version_id, product_version_no, asin_display, asin_normalized, product_name_snapshot, review_type, amazon_order_number_raw, amazon_order_number_normalized, final_paid_jpy, status, version, confirmed_by_staff_id, confirmed_at, confirmed_business_date, created_at) VALUES
      ('formal-order-chat-1', 'chat-submission-1', 'chat-evidence-version-1', 'chat-reservation-1', 'chat-demand-1', 'buyer-customer-0001', 'buyer-001', 'org-1', 'store-1', 'JP', 'product-1', 'product-version-1', 1, 'B012345678', 'B012345678', '商品一', 'IMAGE', '111-1111111-1111111', '111-1111111-1111111', 1980, 'CONFIRMED', 1, 'staff-chat-uploader', 1, '2026-08-01', 1),
      ('formal-order-chat-2', 'chat-submission-2', 'chat-evidence-version-2', 'chat-reservation-2', 'chat-demand-2', 'buyer-customer-0001', 'buyer-001', 'org-1', 'store-1', 'JP', 'product-1', 'product-version-1', 1, 'B012345679', 'B012345679', '商品二', 'IMAGE', '222-2222222-2222222', '222-2222222-2222222', 1980, 'CONFIRMED', 1, 'staff-chat-uploader', 1, '2026-08-01', 1);
