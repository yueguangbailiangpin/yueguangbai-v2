...
const ROLE_DEFAULT_PERMISSIONS: Readonly<Record<StaffRoleCode, readonly StaffPermissionCode[]>> = Object.freeze({
  ...
  acquisition: [],
  pre_sales: [
    'TASK_VIEW_OPEN','TASK_CLAIM','BUYER_VIEW','BUYER_CREATE','BUYER_ACTIVATE_STANDARD',
    ...
    'ASSIGNMENT_ELIGIBLE_BUYER_PRE_SALES','ACQUISITION_BUYER_LEAD',
  ],
  seller_ops: [
    'TASK_VIEW_OPEN','TASK_CLAIM','SELLER_VIEW','SELLER_MANAGE','PRODUCT_VIEW','PRODUCT_REVIEW',
    'DEMAND_VIEW','DEMAND_PUBLISH','ORDER_VIEW','SELLER_SETTLEMENT_VIEW','SELLER_SETTLEMENT_RECORD',
    'ASSIGNMENT_ELIGIBLE_SELLER_ACCOUNT','ACQUISITION_SELLER_LEAD',
  ],
  buyer_refund: [
    'TASK_VIEW_OPEN','TASK_CLAIM','BUYER_VIEW','ORDER_VIEW','REVIEW_VIEW','REVIEW_DECIDE',
    'BUYER_REFUND_VIEW','BUYER_REFUND_RECORD','ASSIGNMENT_ELIGIBLE_BUYER_AFTER_SALES',
