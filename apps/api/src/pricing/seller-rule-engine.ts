...
export async function decideSellerRuleVersion(
  ...
  try {
    ...
    // Dual control is by role separation (seller_ops submits, Owner with
    // FINANCIAL_CORRECT decides via requireOwnerConfirmer above); a
    // single-handed Owner may confirm their own submission.
