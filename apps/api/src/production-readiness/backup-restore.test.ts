...
describe('encrypted D1 backup and isolated restore', () => {
  it('backs up schema 43, restores it and verifies rows, finance, relations and smoke reads', async () => {
    ...
    expect(backup.manifest.schema_version).toBe(43);
    ...
    expect(backup.manifest.inventory.triggers).toHaveLength(357);
    expect(backup.manifest.inventory.indexes).toHaveLength(244);
