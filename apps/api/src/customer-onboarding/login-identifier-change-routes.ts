...
function owner(context:Context<AppEnv>){const actor=context.get('staffAuthorization') as AssignmentStaffAuthorization|undefined;if(!actor||actor.staffStatus!=='ACTIVE'||!actor.roles.has('owner')||!actor.permissions.has('BUYER_IDENTITY_HIGH_RISK_MANAGE'))throw new IdentifierChangeError('FORBIDDEN',403);return actor;}
