...
describe('Phase 4B2 buyer order evidence HTTP API', () => {
  ...
  it('keeps migration 0001-0013 and creates no formal order or finance', async () => {
    setup();
    ...
    expect(migrations.at(-1)).toMatch(/^0013_/u);
    ...
    expect(Number(schema?.schema_version)).toBe(13);
