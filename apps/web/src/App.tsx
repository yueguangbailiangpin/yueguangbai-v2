...
function StaffLogin(): React.JSX.Element {
  ...
  async function enter() {
    ...
    try {
      ...
      setMessage(
        '无法建立员工会话，请确认该邮箱已通过 Cloudflare Access 验证，且已在月光白员工管理中启用。',
      );
    } finally {
      setBusy(false);
    }
  ...
  return (
    <main className="login-page identity-staff">
      <Card className="login-card staff-login-card">
        ...
        <div className="login-heading">
          <p className="eyebrow">内部员工入口</p>
          <h1>员工登录</h1>
          <p>
            员工身份通过 Cloudflare Access 邮箱验证码验证，月光白会再校验岗位、负责站点和账号状态。
          </p>
        </div>
        {message ? (
          ...
          <Alert tone="info">
            首次访问时，Cloudflare 会先要求您用已授权的邮箱完成一次性验证码验证。
          </Alert>
        )}
        ...
        <p className="security-note">
          Cloudflare 只证明邮箱身份；员工角色和数据范围始终由月光白控制。
        </p>
      </Card>
    </main>
  );
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <CustomerPasswordRouteBoundary target="buyer">
            <CustomerChangePasswordPage target="buyer" />
      ...
      <Route
        ...
        element={
          <CustomerPasswordRouteBoundary target="seller">
            <CustomerChangePasswordPage target="seller" />
          </CustomerPasswordRouteBoundary>
        }
      />
      ...
      <Route
        ...
        element={
          <CustomerSessionBoundary target="buyer">
            <RouteChunkBoundary load={loadBuyerLayout} />
      ...
      >
        ...
        <Route path="demands" element={<BuyerRouteSlot />} />
        <Route path="demands/:demandId" element={<BuyerRouteSlot />} />
        <Route path="reservations" element={<BuyerRouteSlot />} />
        <Route path="reservations/:reservationId" element={<BuyerRouteSlot />} />
        <Route path="reservations/:reservationId/instruction" element={<BuyerRouteSlot />} />
        <Route path="order-materials" element={<BuyerRouteSlot />} />
        <Route path="order-materials/new" element={<BuyerRouteSlot />} />
        <Route path="order-materials/:submissionId" element={<BuyerRouteSlot />} />
        <Route path="orders" element={<BuyerRouteSlot />} />
        <Route path="orders/:formalOrderId" element={<BuyerRouteSlot />} />
        <Route path="reviews" element={<BuyerRouteSlot />} />
        <Route path="reviews/new" element={<BuyerRouteSlot />} />
        <Route path="reviews/:reviewCaseId" element={<BuyerRouteSlot />} />
        <Route path="refunds" element={<BuyerRouteSlot />} />
        <Route path="refunds/:refundId" element={<BuyerRouteSlot />} />
      ...
      <Route
        ...
        element={
          <CustomerSessionBoundary target="seller">
            <RouteChunkBoundary load={loadSellerLayout} />
          </CustomerSessionBoundary>
        }
      >
        <Route index element={<SellerRouteSlot />} />
        <Route path="products" element={<SellerRouteSlot />} />
        <Route path="products/new" element={<SellerRouteSlot />} />
        <Route path="products/:applicationId" element={<SellerRouteSlot />} />
        <Route path="demands" element={<SellerRouteSlot />} />
        <Route path="demands/new" element={<SellerRouteSlot />} />
      ...
      <Route
        ...
        element={
          <StaffSessionBoundary>
            <RouteChunkBoundary load={loadStaffShell} />
          </StaffSessionBoundary>
        }
      >
      ...
      <Route
        ...
        element={
          <main className="centered">
            <PermissionDenied requestId="local-permission-request" />
          </main>
        }
      />
      <Route
        ...
        element={
          <main className="centered">
            <ErrorState title="服务暂时不可用" requestId="local-request" />
          </main>
        }
      />
      <Route path="*" element={<DomainNotFound />} />
  ...
  return (
    <Routes>
      ...
      <Route
        path="/buyer/*"
        element={
          <CustomerSessionBoundary target="buyer" adapter={reviewBuyerAuthApi}>
            <RouteChunkBoundary load={loadBuyerLayout} />
          </CustomerSessionBoundary>
        }
      >
      ...
      <Route
        path="/seller/*"
        element={
          <CustomerSessionBoundary target="seller" adapter={reviewSellerAuthApi}>
            <RouteChunkBoundary load={loadSellerLayout} />
          </CustomerSessionBoundary>
        }
      >
      ...
      <Route
        path="/staff/*"
        element={
          <StaffSessionBoundary adapter={reviewStaffAuthApi}>
            <RouteChunkBoundary load={loadStaffShell} />
          </StaffSessionBoundary>
        }
      >
  ...
  if (isReviewRuntime()) {
    return (
      <QueryClientProvider client={reviewQueryClient}>
        <SessionInvalidationClientLifecycle>
