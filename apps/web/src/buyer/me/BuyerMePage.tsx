...
export function BuyerMePage(): React.JSX.Element {
  ...
  const me = query.data;
  return <section className="buyer-page buyer-flow-page buyer-account-page">
    <BuyerJourney current={null} />
    <PageHeader eyebrow="我的" title={me.buyer.display_name} description="查看账户状态与业务记录">
    ...
    <Card className="buyer-summary-card buyer-account-summary"><h2>账户信息</h2><dl className="buyer-facts"><div><dt>市场</dt><dd>{marketplaceLabel(me.buyer.marketplace_code)}</dd></div></dl></Card>
