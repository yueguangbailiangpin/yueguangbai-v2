...
export function StaffRoutePage():React.JSX.Element{
  const {pathname}=useLocation();const session=useCurrentStaffSession();
  if(pathname==='/staff'&&session.role.code==='acquisition')return <Navigate to="/staff/acquisition" replace/>;
