...
export const acquisitionProspectStatusSchema = z.enum([
  'NEW',
  'RESEARCHING',
  'QUALIFIED',
  'READY_CONTACT',
...
export const acquisitionChannelSchema = z
  ...
  .strict();
export const acquisitionInternalChannelViewSchema = acquisitionChannelSchema
  .extend({
    visibility: z.literal('INTERNAL'),
    staff_label: z.string(),
    intake_wechat_label: z.string().nullable(),
    profile_version: z.number().int().positive(),
  })
  .strict();
export const acquisitionStaffChannelViewSchema = z
  .object({
...
export const acquisitionChannelsResponseSchema = z
  .object({ channels: z.array(acquisitionVisibleChannelSchema) })
  .strict();

export const acquisitionProspectSchema = z
  .object({
    prospect_id: z.string(),
    lead_type: acquisitionLeadTypeSchema,
    marketplace_code: z.string(),
  ...
  .strict();
export const acquisitionHandoffSchema = z
  .object({
    prospect_id: z.string(),
    lead_type: acquisitionLeadTypeSchema,
    marketplace_code: z.string(),
    ...
    display_name: z.string(),
    contact_value: z.string().nullable(),
    status: z.literal('HUMAN_HANDOFF'),
    version: z.number().int().positive(),
    created_at: epoch,
    updated_at: epoch,
  })
...
export const acquisitionLeadSchema = z
  ...
  .strict();
export const acquisitionLeadsPageSchema = z
  .object({ items: z.array(acquisitionLeadSchema), next_cursor: z.string().nullable() })
  .strict();
export const acquisitionDailyConsultationSchema = z
  .object({
