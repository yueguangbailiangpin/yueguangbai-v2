...
export const settlementSummary = {
  outstanding_principal_cny_fen: '80000',
...
export const settlementPayables = [
  {
    ...
    store: { id: 'store-1', display_name: '美国店铺' },
    product: { id: 'product-1', asin: 'B000000001', name: '产品' },
    payable_type: 'SELLER_PRINCIPAL' as const,
    due_amount_cny_fen: '80000',
    paid_amount_cny_fen: '0',
    outstanding_amount_cny_fen: '80000',
    status: 'UNPAID' as const,
    due_at: 1_787_000_000_000,
    created_at: 1_787_000_000_000,
  },
  {
    payable_id: 'fee-1',
    ...
    store: { id: 'store-1', display_name: '美国店铺' },
    product: { id: 'product-1', asin: 'B000000001', name: '产品' },
    payable_type: 'SELLER_SERVICE_FEE' as const,
    due_amount_cny_fen: '12000',
    paid_amount_cny_fen: '0',
    outstanding_amount_cny_fen: '12000',
    status: 'UNPAID' as const,
    due_at: 1_787_000_000_000,
    created_at: 1_787_000_000_000,
  },
...
export const settlementPayment = {
  ...
  recorded_at: 1_787_000_000_000,
  allocated_amount_cny_fen: '0',
  unallocated_amount_cny_fen: '3000',
  status: 'UNALLOCATED' as const,
  version: 1,
  allocations: [],
  proof: {
    file_object_id: 'proof-1',
    file_version: 2,
