...
export function StaffAccountsWorkspace():React.JSX.Element{
  ...
  return <main className="staff-access-management staff-accounts-simple">
    ...
    <AccountDialog key="create-staff" title="新增员工" open={creating} marketplaces={query.data.available_marketplaces} busy={createMutation.isPending} onClose={()=>setCreating(false)} onSubmit={(body)=>createMutation.mutate(body)}/>
