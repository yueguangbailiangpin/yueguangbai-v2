...
export function SellerRegistrationPage():React.JSX.Element{
  ...
  return <main className="login-page identity-seller"><Card className="login-card seller-login-card"><div className="login-brand"><strong>月光白</strong></div><div className="login-heading"><h1>开通卖家后台</h1><p>仅限工作人员发送的专属注册链接，一次性有效。</p></div>
