...
export function SellerSettingsV2Page():React.JSX.Element{
  const client=useQueryClient();const me=useQuery({queryKey:sellerQueryKeys.me,queryFn:({signal})=>sellerApi.me(client,signal).then((r)=>r.data.me)});
  return <section className="seller-page"><PageHeader title="账户与团队" eyebrow="账户安全" />
