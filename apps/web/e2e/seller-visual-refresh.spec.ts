...
const orders = [
  { formal_order_id: 'order-rice', status: 'CONFIRMED', marketplace_code: 'JP', canonical_marketplace_code: 'AMAZON_JP', amazon_order_number: '503-1234567-1234567', platform_order_identifier: '503-1234567-1234567', store: { id: 'store-jp', display_name: '东京一号店' }, asin: 'B07W5DMQ3R', platform_product_identifier: 'B07W5DMQ3R', product_name: '象印 IH 电饭煲 5.5 合', product_version: { id: 'version-rice', version_no: 2 }, review_type: 'IMAGE', final_paid_jpy: '22800', payment: { amount_minor: '22800', currency_code: 'JPY', currency_exponent: 0 }, seller_expected_principal_cny_fen: '91200', seller_agreement_rate_snapshot: { rate_version_id: 'rate-jp', version_no: 8, cny_per_jpy_e8: '4000000', effective_from: fixedNow - 10_000_000, confirmed_at: fixedNow - 8_000_000, source_currency_code: 'JPY', quote_currency_code: 'CNY', source_currency_exponent: 0, quote_currency_exponent: 2, rate_value: '4000000', rate_scale: '100000000', rounding_rule: 'HALF_UP' }, locked_service_fee_snapshot: { fee_version_id: 'fee-image', version_no: 4, review_type: 'IMAGE', service_fee_cny_fen: '3200', effective_from: fixedNow - 10_000_000, confirmed_at: fixedNow - 8_000_000, marketplace_code: 'AMAZON_JP', currency_code: 'CNY', currency_exponent: 2 }, business_completion: { status: 'IN_PROGRESS', review: 'COMPLETE', buyer_refund: 'PENDING', seller_principal: 'COMPLETE', seller_service_fee: 'PENDING' }, confirmed_at: fixedNow - 7_200_000, confirmed_business_date: '2026-08-09' },
  { formal_order_id: 'order-kettle', status: 'CONFIRMED', marketplace_code: 'JP', canonical_marketplace_code: 'AMAZON_US', amazon_order_number: '113-7654321-7654321', platform_order_identifier: '113-7654321-7654321', store: { id: 'store-us', display_name: '北美精品店' }, asin: 'B08J7H2K5L', platform_product_identifier: 'B08J7H2K5L', product_name: '山善电热水壶 0.8L', product_version: { id: 'version-kettle', version_no: 1 }, review_type: 'TEXT', final_paid_jpy: '4599', payment: { amount_minor: '4599', currency_code: 'USD', currency_exponent: 2 }, seller_expected_principal_cny_fen: '33000', seller_agreement_rate_snapshot: { rate_version_id: 'rate-us', version_no: 2, cny_per_jpy_e8: '0', effective_from: fixedNow - 10_000_000, confirmed_at: fixedNow - 9_000_000, source_currency_code: 'USD', quote_currency_code: 'CNY', source_currency_exponent: 2, quote_currency_exponent: 2, rate_value: '720000000', rate_scale: '100000000', rounding_rule: 'HALF_UP' }, locked_service_fee_snapshot: { fee_version_id: 'fee-text', version_no: 3, review_type: 'TEXT', service_fee_cny_fen: '1800', effective_from: fixedNow - 10_000_000, confirmed_at: fixedNow - 9_000_000, marketplace_code: 'AMAZON_US', currency_code: 'CNY', currency_exponent: 2 }, business_completion: { status: 'COMPLETE', review: 'COMPLETE', buyer_refund: 'COMPLETE', seller_principal: 'COMPLETE', seller_service_fee: 'NOT_APPLICABLE' }, confirmed_at: fixedNow - 10_800_000, confirmed_business_date: '2026-08-08' },
] as const;
