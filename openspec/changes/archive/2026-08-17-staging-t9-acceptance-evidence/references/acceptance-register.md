...
| C06 | ASIN Marketplace 唯一。 | PASS | REMOTE_HTTP | Same-market duplicates PASS (D02). Cross-market defect FIXED in PR #99: createSellerStore no longer hardcodes the JP legacy projection - non-JP store creation now returns 409 MARKETPLACE_NOT_SUPPORTED until the business tables support canonical codes (verified on staging 2026-08-17). Evidence T9-BCG-IDENTITY-NUMBERING-PASS.md. |
