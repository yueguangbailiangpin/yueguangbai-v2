...
- [x] 2.4 Complete Formal Verify and record exact current-SHA evidence.

## 3. Disposable D1 canary

- [x] 3.1 Create one uniquely named staging-only D1 canary and verify it is distinct from staging and production IDs.
- [x] 3.2 Apply exact migrations `0001`–`0068`; export and verify native SQLite integrity/FK/Schema/ledger.
- [x] 3.3 Apply exact migrations `0069`–`0070`; verify remote Schema/ledger/FK/object/column inventory.
- [x] 3.4 Export Schema 70 and repeat native SQLite full-health verification.
- [x] 3.5 Delete the canary and prove the exact name/ID no longer exists.
