...
- [x] 12. **T11 — CI browser coverage:** add the independent Playwright CI job for the approved local 13-spec suite as a separate code PR; it must not access staging, production, Cloudflare resources or real data. Evidence: PR #81, merge `21026cedf609240547a68ae3b8745b4b63808214`, plus subsequent `browser-e2e` CI runs on PR #86.
