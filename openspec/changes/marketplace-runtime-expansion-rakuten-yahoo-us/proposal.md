...
Owner 2026-09-01 拍板：乐天、雅虎、美国亚马逊三平台全开；同日上午补充裁决追加 TEMU 日本站与 TikTok 日本站，共五个平台。当前运行时 canonical 仅 AMAZON_JP 可写（AMAZON_US 未启用、COUPANG_KR 禁用预留，D-056），来源层数据已有 8 个乐天卖家（标识 R-1/S-1 归档认可）、3 个雅虎商品（13 位 JAN 条码）与若干美国站行。本草案把三平台纳入运行时，先经 Codex 只读审查再实现。
