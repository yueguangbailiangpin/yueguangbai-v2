...
- **THEN** the legacy Staff workbench and its MSW test are removed without leaving a second Seller Settlement implementation, runtime import, verifier marker or test dependency.
