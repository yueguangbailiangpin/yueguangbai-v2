...
发布前导出完整 D1，并分别保存 R2 清单与 Drive Manifest。隔离恢复演练必须验证：schema 32 升级、Manifest 数量/哈希、已归档文件 Drive 可读、已回灌对象 R2 HEAD 一致、所有原 Audience 仍有效。生产 D1、R2、Drive 的真实写入不属于本地验收。
