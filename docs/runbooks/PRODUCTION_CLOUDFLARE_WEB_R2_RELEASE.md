...
4. 只读比较生产 D1 ledger 与 release 的连续 `0001`–`0037`（尾部为 `0037_stage75_multimarket_staff_order_list_index.sql`）。0037 仅为未来多市场上线前性能准备；未知、跳号、重复、并行、部分 Migration 或 schema 不匹配立即停止。
