...
- 当前目标 Schema：71；迁移链 0001–0071 全部应用（db:verify 实测：71 migrations / 212 tables / 604 indexes / 401 triggers / 12 views / FK 0）；0001–0064 保持既有历史，0065 前向删除未使用的飞书 Schema / 旧清理任务，0066 advance-cash 完整性、0067 advance V1 全款、0068 客户安全 DENY + 密码限流、0069 卖家协议费率运行时退役、0070 买家发起的返款提醒（T7）、0071 产品申请参考金额
