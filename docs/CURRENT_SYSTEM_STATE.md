...
- 当前 Schema：37（阶段 7.5 追加 0031 员工订单列表索引、0032 公司公开客服渠道、0033 卖家结算批次；阶段 7.5R 追加 0034 `SERVICE_CHANNEL_QR` 受控文件链、0035 结算批次取消修复、0036 `BATCH_CANCELLED` 保留标记；本 Change 追加 0037 多市场 Staff 订单列表性能准备索引）
